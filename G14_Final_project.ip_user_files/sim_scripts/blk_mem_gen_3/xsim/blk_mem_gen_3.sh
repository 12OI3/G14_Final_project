...
#
# Generated by Vivado on Sun Jan 16 13:30:48 +0800 2022
...
# Script info
echo -e "blk_mem_gen_3.sh - Script generated by export_simulation (Vivado v2021.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_3 xil_defaultlib.blk_mem_gen_3 xil_defaultlib.glbl -log elaborate.log
}

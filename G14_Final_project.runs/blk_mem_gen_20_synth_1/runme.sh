...
HD_PWD='D:/File/NTHU/2A/verilog/G14_Final_project/G14_Final_project.runs/blk_mem_gen_20_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_20.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_20.tcl
